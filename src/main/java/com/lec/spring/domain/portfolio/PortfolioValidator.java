...
public class PortfolioValidator implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        ...
        if (portfolio.getExperience().length() > 75) {
            errors.rejectValue("experience", "경력은 최대 75자까지 입력할 수 있습니다.");
        }

        if (portfolio.getUserPr().length() > 75) {
            errors.rejectValue("userPr", "자기 소개는 최대 75자까지 입력할 수 있습니다.");
        }
    }
}
